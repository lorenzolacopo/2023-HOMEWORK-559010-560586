...
public class Borsa {
	...
	public boolean getPesoRimanente(Attrezzo a) {
		if(a!=null && 
		this.getPesoMax()-this.getPeso()>=a.getPeso())
			return true;
		return false;
	}
	...
	private int getPosizioneAttrezzo(String nomeAttrezzo) {
		...
		for (posizioneAttrezzoDaCercare = 0; posizioneAttrezzoDaCercare<this.numeroAttrezzi; posizioneAttrezzoDaCercare++) {
			if (this.attrezzi[posizioneAttrezzoDaCercare].getNome().equals(nomeAttrezzo))
